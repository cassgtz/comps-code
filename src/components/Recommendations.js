...
export default class Recommendations extends Component {
  ...
  // if we are checking all, display the recommendations 
                ...
                {this.props.missing_vitamins.length !== 0 ?
                        <div>
                            ...
                            <ListContainer 
                                ...
                                missing_vitamins = {this.props.checkAll !== 0 ? this.props.missing_vitamins : this.props.filtered_missing_vitamins}
                            />
